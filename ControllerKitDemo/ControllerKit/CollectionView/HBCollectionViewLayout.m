...
@interface HBCollectionViewLayout ()

@property (nonatomic, weak) id <HBCollectionViewLayoutDelegate> aDelegate;  //自动设置的代理
...
@implementation HBCollectionViewLayout
...
- (void)prepareLayout {
    ...
    self.aDelegate = (id <HBCollectionViewLayoutDelegate>)self.collectionView.dataSource;
    ...
    for (NSInteger section = 0; section < numberOfSections; ++section) {
        ...
        if (headerHeight > 0) {
            attributes = [UICollectionViewLayoutAttributes layoutAttributesForSupplementaryViewOfKind:HBCollectionViewHeader withIndexPath:[NSIndexPath indexPathForItem:0 inSection:section]];
        ...
        if (footerHeight > 0) {
            attributes = [UICollectionViewLayoutAttributes layoutAttributesForSupplementaryViewOfKind:HBCollectionViewFooter withIndexPath:[NSIndexPath indexPathForItem:0 inSection:section]];
